...
const DEFAULT_PERMISSIONS = {
  admin:     { dashboard: true,  historica: true,  radar: true,  b2c: true, b2b: true, historial: true,  visitas: true,  visitas_pymes: true,  fichajes: true,  reportes: true  },
  manager:   { dashboard: false, historica: false, radar: true,  b2c: true, b2b: true, historial: false, visitas: true,  visitas_pymes: true,  fichajes: true,  reportes: true  },
  comercial: { dashboard: false, historica: false, radar: false, b2c: true, b2b: true, historial: false, visitas: true,  visitas_pymes: true,  fichajes: true,  reportes: true  },
};
