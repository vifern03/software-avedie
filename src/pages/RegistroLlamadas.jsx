...
export const CALLES_PALENCIA = [
  // ── Calles nuevas (orden Excel, izquierda → derecha) ──────────────────────
  'CALLE DON SANCHO',
  'CALLE LA CESTILLA',
  'MENENDEZ PELAYO',
  'ANTONIO MAURA',
  ...
  'CALLE COLON',
  'LOS SOLDADOS',
  'URB LA PALOMA VILLALOBON',
  'CASTILLA',
  'GIL DE FUENTES',
  'AV CUBA',
  'CAMPOS GOTICOS',
  'PASEO DEL OTERO',
  // ── Calles ya existentes (se mantienen en su posición del Excel) ──────────
  'AV SANTANDER',
  'MAYOR ANTIGUA',
  'VICTORIO MACHO',
  'P. LA JULIA',
  ...
  'URB LOS OLMILLOS',
  // ── Calles nuevas (continuación orden Excel) ──────────────────────────────
  'JARDIN VIRGEN DEL MILAGRO VILLA',
  ...
  'CLARA CAMPOAMOR',
  'VIRGEN DEL BREZO',
  // ── Calles nuevas (Excel "direcciones adicionales PALENCIA (1)", orden de hojas) ──
  'SANTO DOMINGO PAREDES DE NAVA',
  'REGALADOS BECERRIL DE CAMPOS',
  'PLAZA MAYOR BECERRIL DE CAMPOS',
  'AV BAÑOS VENTA DE BAÑOS',
  'MODESTO LAFUENTE VENTA DE BAÑOS',
  'AV PABLO PICASSO VENTA DE BAÑOS',
  'LOPE DE VEGA VENTA DE BAÑOS',
  'LINEA FERROCARRIL VENTA DE BAÑOS',
  'ZONA DE DOS PASOS GRIJOTA',
  'URB EL PALOMAR GRIJOTA',
  'CIUDAD DEL GOLF GRIJOTA',
  'URB CIUDAD DE LA JUVENTUD GRIJOTA',
  'CALLE BURGOS',
  'CALLE EDUARDO DATO',
  'CALLE FLORIDABLANCA',
  'MARIA DE PADILLA',
