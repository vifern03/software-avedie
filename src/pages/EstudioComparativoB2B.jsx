        ...
        <div>
          {!isReady ? (
            ...
            <div id="ecb2b-informe" className="bg-white border border-google-border rounded-xl shadow-sm overflow-hidden">
              ...
              {/* Cabecera azul */}
              <div className="bg-gradient-to-r from-gray-800 to-gray-900 px-6 pt-6 pb-5 text-white relative">
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex-1 min-w-0">
                    <p className="text-[10px] font-bold uppercase tracking-widest text-gray-300 mb-1">GRUPO AVEDIE · COMPARATIVA ENERGÉTICA B2B</p>
                    <h3 className="text-xl font-bold leading-tight">{form.cliente || 'Sin nombre'}</h3>
                    {form.cups && <p className="text-xs text-gray-300 font-mono mt-0.5">{form.cups}</p>}
                  </div>
                ...
                <div className="flex flex-wrap gap-2 pr-40">
                  <span className="bg-white/20 text-white text-[11px] font-semibold px-2.5 py-1 rounded-full">{tarifaLabel}</span>
